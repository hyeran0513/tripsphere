...
export const addRooms = async (accommodationIds) => {
  ...
  const newRooms = [
    ...
    },
    {
      ...
      check_in: new Date('2025-04-01T14:00:00+09:00'),
      check_out: new Date('2025-04-01T16:30:00+09:00'),
      description:
    ...
    },
    {
      ...
      check_in: new Date('2025-05-13T14:00:00+09:00'),
      check_out: new Date('2025-05-13T16:30:00+09:00'),
      description:
        '주차 시설을 보유한 숙소입니다. (차량 이용 시 숙소에 문의해 주세요.)\n객실은 체크인 시 배정되며 사진과 다를 수 있습니다.',
      discount_rate: 0.1,
      images: [
        'https://image.goodchoice.kr/adimg_new/55/449529/add4281fa8adbccbaffdae9cbadd09bb.jpg',
      ],
      name: 'C-타입',
      original_price: 40000,
    ...
    },
    {
      ...
      check_in: new Date('2025-03-31T14:52:09+09:00'),
      check_out: new Date('2025-05-05T14:52:36+09:00'),
      description:
        '만 19세 미만 청소년 혼숙은 법적으로 불가하며, 이에 대한 숙소의 입실 거부 시 취소/환불이 불가합니다.\n만 19세 미만 청소년 예약에 대한 숙소의 입실 거부 시 취소/환불이 불가하오니, 예약 전 반드시 숙소에 확인하시기 바랍니다.',
      discount_rate: 0.5,
      images: [
        'https://image.goodchoice.kr/adimg_new/55/1520/c95216dd061edcd67477076370f17ae7.jpg',
      ],
      name: 'D-타입',
      original_price: 40000,
      services: ['wifi', 'parking', 'barbecue'],
